...
def sulzmanMatch(r: Rexp, s: String, c: Int) : String = {
    try {
        lexer(r, s, c)
        "succes"
    }catch {
...
for(i <- 1 to 4000 by 500) {
    println(i + ": " + time_needed(1, lexer(evil0(i), "a"*i + "b"*i, 1)) + "; " + 
...
for(i <- 0 to 10000 by 1000) {
    println(i + ": " + time_needed(1, sulzmanMatch(evil2, "a"*i+"!", 50)) + "; " + 
...
for(i <- 500 to 3000 by 500) {
    println(i + ": " + time_needed(1, sulzmanMatch(evil3, "a"*i+"b", 1)) + "; " + 
...
for(i <- 0 to 5000 by 500) {
    println(i + ": " + time_needed(10, sulzmanMatch(evil5, "a"*i, 1)))
}
...
for(i <- 0 to 1750 by 200) {
    println(i + ": " + time_needed(1, sulzmanMatch(reg1, "abc:12"*i, 30)) + "; " + 
